...
const (
	...
	FileService_NotifyIngest_FullMethodName = "/file.FileService/NotifyIngest"
)
...
type FileServiceClient interface {
	...
	NotifyIngest(ctx context.Context, in *FileIngestEvent, opts ...grpc.CallOption) (*FileIngestResponse, error)
}
...
func (c *fileServiceClient) NotifyIngest(ctx context.Context, in *FileIngestEvent, opts ...grpc.CallOption) (*FileIngestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileIngestResponse)
	err := c.cc.Invoke(ctx, FileService_NotifyIngest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServiceServer interface {
	...
	// 🚀 Go -> Python を gRPC で直接叩く、あるいは Pub/Sub の型として保証するために追加
	NotifyIngest(context.Context, *FileIngestEvent) (*FileIngestResponse, error)
...
func (UnimplementedFileServiceServer) NotifyIngest(context.Context, *FileIngestEvent) (*FileIngestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyIngest not implemented")
}
...
func _FileService_NotifyIngest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FileIngestEvent)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).NotifyIngest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_NotifyIngest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).NotifyIngest(ctx, req.(*FileIngestEvent))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NotifyIngest",
			Handler:    _FileService_NotifyIngest_Handler,
		},
	},
